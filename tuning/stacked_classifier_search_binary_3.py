...
df_train["binary_label_cutoff_3"] = (df_train["overall"] > 3).astype(int)
...
label_col = "binary_label_cutoff_3"
...
base_gb = GradientBoostingClassifier(validation_fraction=0.08, n_iter_no_change=30, tol=1e-4, random_state=42)

meta_lr = LogisticRegression(solver='lbfgs', class_weight='balanced', random_state=42, max_iter=10000)
...
param_dist = {
    ...
    "prep__text__max_features": [5000, 7000], # from 5000, 8000, 12000
    "prep__text__min_df": [4, 5],
    "prep__text__max_df": [0.75, 0.85],
    #"prep__text__binary": [False, True],
    "prep__text__stop_words": [None],
    "prep__text__norm": [None],
    "prep__text__use_idf": [False],
    "prep__text__sublinear_tf": [True],
    "prep__text__token_pattern": [r"\w{2,}"],
    
    # Custom features
    "prep__num__weight__sentiment_weight": [1.5],  

    # RandomForest
    "clf__rf__n_estimators": randint(60, 85), # changed from 50, 150
    "clf__rf__max_depth": [17], # switched None to 20
    # GradientBoosting
    "clf__gb__n_estimators": randint(60, 100), # changed from 120
    "clf__gb__learning_rate": loguniform(1e-2, 1),
    "clf__gb__max_depth": [5],
    # meta logistic
    "clf__final_estimator__C": loguniform(1e-3, 0.1),
    # base logistic
    "clf__lr__C": loguniform(1e-4, 0.3), 
...
out_path = "results/submission_binary_split_3_from_tuner-v4.csv"
